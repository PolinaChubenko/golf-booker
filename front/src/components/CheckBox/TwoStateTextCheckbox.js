...
const TwoStateTextCheckbox = ({name, value = 0, disabled = false, onChange = null}) => {
    ...
    return (
        <div style={{
            ...
            <input ref={inputRef} type="checkbox" className={style.textcheckbox} name={name} onClick={handleClick} disabled={disabled}/>
        </div>
    );
};

export default TwoStateTextCheckbox;